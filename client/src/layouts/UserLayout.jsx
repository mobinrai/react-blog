  ...
  return (
    <section className="user-dashboard">
            ...
            <div className="max-w-6xl mx-auto py-6 flex flex-col md:flex-row gap-4">
                <aside className='flex flex-col gap-4 border-r px-4 md:w-1/3'>
                    <a href="" className='border-b pb-3 capitalize hover:text-[#ee4276] transition-all'>view all post</a>
                    ...
                    create post</a>
                    <a href="" className='border-b pb-3 capitalize hover:text-[#ee4276] transition-all'>
                    add litte about you/ describe your self</a>
